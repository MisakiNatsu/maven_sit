    ...
    <section id="tabla">
      <table class="" id="miTabla" style="width:100%;">
        ...
        <tbody>
            ...
            List<UnidadTransporteDTO> lista = dao.listarCompletoUnidadTransportistasReactivar();
          ...
          <tr>
            ...
            <td style="background-color:#1e1e20;"><a href="../../UnidadTransporteServlet?accion=reactivar&idUni=<%=uni.getId()%>">Reactivar</a></td>
          </tr>
          <%}%>
        </tbody>
